...
private:
	...
	/* Produces all the edges between the nodes given by the generators of the persistence diagrams
	 * stored in Generators1 and Generators2. The diagram are augmented to the same length by projections to the diagonal.
	 */
	void PrepareEdges( );
